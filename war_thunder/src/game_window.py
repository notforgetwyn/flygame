...
class GameView(arcade.View):
    ...
    def draw_health_bar(self):
        ...
        health_ratio = self.player_sprite.health / PLAYER_MAX_HEALTH
        health_color = arcade.color.GREEN if health_ratio > 0.5 else arcade.color.RED if health_ratio > 0.25 else arcade.color.ORANGE
    ...
    def on_draw(self):
        ...
        arcade.draw_text('移动: ←→↑↓ 或 WASD   射击: Space/Z   暂停: ESC', SCREEN_WIDTH // 2, 30,
